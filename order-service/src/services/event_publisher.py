...
class EventPublisher:
    ...
    def connect(cls):
        ...
        if cls._connection is None or cls._connection.is_closed:
            try:
                ...
                logger.info("Connected to RabbitMQ and declared exchanges/queues")
    ...
    @classmethod
    def publish_order_created(cls, order_id: str, customer_id: str, items: list):
        ...
        try:
            ...
            logger.info(f"Published OrderCreated event for order {order_id}")
